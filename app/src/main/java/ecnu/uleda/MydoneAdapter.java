...
public class MydoneAdapter extends ArrayAdapter<MyOrder> {
    public MydoneAdapter(Context context, List<MyOrder> objects){
        super(context,R.layout.done_item,objects);
    }
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent){
        ...
        if(convertView==null)
        {
            v = LayoutInflater.from(getContext().getApplicationContext()).inflate(R.layout.done_item,parent,false);
