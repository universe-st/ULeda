...
public class MydoneAdapter extends RecyclerView.Adapter<MydoneAdapter.MyDoneViewHolder> {
    ...
    public MyDoneViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyDoneViewHolder(mInflater.inflate(R.layout.done_item, parent, false));
    }
