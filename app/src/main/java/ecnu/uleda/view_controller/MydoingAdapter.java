...
public class MydoingAdapter extends RecyclerView.Adapter<MydoingAdapter.MyDoingViewHolder> {
    ...
    public MydoingAdapter(Context context, List<MyOrder> objects) {
    ...
    @Override
    public MyDoingViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_EMPTY) {
            ...
            return new MyDoingViewHolder(emptyView);
        }
        return new MyDoingViewHolder(mInflater.inflate(R.layout.doingitem, parent, false));
    }

    @Override
    public void onBindViewHolder(MyDoingViewHolder viewHolder, int position) {
    ...
    static class MyDoingViewHolder extends RecyclerView.ViewHolder {
        TextView tasktype;
        ...
        public MyDoingViewHolder(View itemView) {
            super(itemView);
