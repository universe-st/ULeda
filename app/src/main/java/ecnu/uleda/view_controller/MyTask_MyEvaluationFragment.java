...
public class MyTask_MyEvaluationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        mRecyclerView = (RecyclerView) v.findViewById(R.id.mytask_item);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerViewTouchListener(mRecyclerView) {
            ...
            public void onItemClick(int position, RecyclerView.ViewHolder viewHolder) {
                TaskDetailsActivity.startActivityFromMyTask(getActivity(), position, ServerAccessApi.USER_TASK_FLAG_MY);
            }
    ...
    private void loadOrders() {
        ...
        Observable.create(new ObservableOnSubscribe<JSONArray>() {
            ...
            public void subscribe(@NonNull ObservableEmitter<JSONArray> e) throws Exception {
                e.onNext(ServerAccessApi.getUserTask(index, ServerAccessApi.USER_TASK_FLAG_MY));
                e.onComplete();
            }
        })
