...
public class My_toevaluateAdapter extends RecyclerView.Adapter<My_toevaluateAdapter.MyEvalViewHolder> {
    ...
    @Override
    public MyEvalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_EMPTY) {
            ...
            return new MyEvalViewHolder(emptyView);
        }
        return new MyEvalViewHolder(mInflater.inflate(R.layout.to_evaluate, parent, false));
    }

    @Override
    public void onBindViewHolder(MyEvalViewHolder viewHolder, int position) {
    ...
    static class MyEvalViewHolder extends RecyclerView.ViewHolder {
        TextView tasktype;
        ...
        public MyEvalViewHolder(View itemView) {
            super(itemView);
