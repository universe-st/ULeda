...
public class UMainActivity extends AppCompatActivity {
    ...
    private void setButtonsPressed(int i){
        switch (i){
            case 0:
                mButtons[0].setBackgroundResource(R.drawable.map_bt_pressed);break;
            case 1:
                mButtons[1].setBackgroundResource(R.drawable.task_bt_pressed);break;
            case 2:
                mButtons[2].setBackgroundResource(R.drawable.ucircle_bt_pressed);break;
            case 3:
                mButtons[3].setBackgroundResource(R.drawable.message_bt_pressed);break;
            case 4:
                mButtons[4].setBackgroundResource(R.drawable.me_bt_pressed);break;
            default:
    ...
    private void setButtonsUnpressed(int i){
        switch (i){
            case 0:
                mButtons[0].setBackgroundResource(R.drawable.map_bt);break;
            case 1:
                mButtons[1].setBackgroundResource(R.drawable.task_bt);break;
            case 2:
                mButtons[2].setBackgroundResource(R.drawable.ucircle_bt);break;
            case 3:
                mButtons[3].setBackgroundResource(R.drawable.message_bt);break;
            case 4:
                mButtons[4].setBackgroundResource(R.drawable.me_bt);break;
            default:
                throw new RuntimeException("Error button code.");
        }
    }
