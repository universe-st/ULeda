...
/**
 * Created by Shensheng on 2017/3/13.
 * RSA加密解密工具
 */
...
public class RSAUtils {
   ...
   // private String pubKey;
     ...
     * 使用私钥加密
     */
    public String encryptByPrivateKey(String data,String priKey) {
        // 加密
        String str = "";
        try {
     ...
     * 使用私钥解密
     */
    public String decryptByPrivateKey(String data,String priKey) {
        // 加密
        String str = "";
        try {
            byte[] pribyte = base64decode(priKey.trim());
     ...
     * 使用公钥加密
     */
    public String encryptByPublicKey(String data,String pubKey) {
        // 加密
        String str = "";
        try {
     ...
     * 使用公钥解密
     */
    public String decryptByPublicKey(String data,String pubKey) {
        // 加密
        String str = "";
        try {
            byte[] pubbyte = base64decode(pubKey.trim());
